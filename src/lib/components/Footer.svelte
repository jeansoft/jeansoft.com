...
>
  ...
  >
    ...
    <div class="w-full md:w-1/3 flex md:justify-end z-10">
      <a
        href="mailto:lertesmith@gmail.com"
  ...
  >
    ...
    <div class="col-span-1 flex flex-col gap-4">
      ...
      <a
        href="https://x.com/lertesmith"
        class="text-white/60 hover:text-white font-sans text-sm transition-colors"
        >Follow on X</a
      >
      <a
        href="https://github.com/jeansoft"
        target="_blank"
  ...
  >
    <p class="text-white/30">&copy; 2026 ♥ Jeansoft</p>

    <div class="flex flex-col md:flex-row items-center gap-4 md:gap-8">
      <div class="gap-6 text-white/30 hidden md:flex">
